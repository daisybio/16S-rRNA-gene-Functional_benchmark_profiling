...
process_element <- function(j) {
  ...
  FOCUS_p1 <- merge(Wilcox_p1_1, Wilcox_wgs_1, all = TRUE)
  FOCUS_p1_adj <- FOCUS_p1[, c(1, 2, 4)]
  colnames(FOCUS_p1_adj) <- c("KO", "prediction", "metagenom")
  FOCUS_p1_adj <- FOCUS_p1_adj[, c(1, 3, 2)]
  FOCUS_p1_p <- FOCUS_p1[, c(1, 3, 5)]
  colnames(FOCUS_p1_p) <- c("KO", "prediction", "metagenom")
  FOCUS_p1_p <- FOCUS_p1_p[, c(1, 3, 2)]
